        ...
        <div className='m-5'>
            <div className='preview-head row gx-0'>
                <div className='head-text col-lg-5 col-md-6 col-sm-12 w-50'>
                    <h2 className='preview-heading '> Angular Js Training</h2>
            ...
            <div className='preview-text d-flex justify-content-between mt-5'>
                        ...
                        <TextField id="outlined-basic" className='fields mt-3 w-100'  label="Full Name" variant="outlined" />
                            ...
                            <FormControl  className=' mt-3 w-100'>
                                ...
                                >
                                    ...
                                    <MenuItem >MERN STACK</MenuItem>
                                    <MenuItem >MEAN STACK</MenuItem>
            ...
            <div className='preview-features  p-3 mt-5 w-100'>
                ...
                <div className='d-flex justify-content-evenly  pt-4'>
                    <div className='features-1  w-50 p-2'>
                    ...
                    <div className='features-2  w-50  p-2'>
                        <ul className='feature-li'>
                    ...
                    <div className='features-3  w-50  p-2'>
                        <ul className='feature-li'>
